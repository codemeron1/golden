...
import { Clock, CheckSquare, Edit2, Trash2, MoreVertical, BarChart2 } from 'lucide-react';
          ...
          <div className="relative p-6">
                ...
                {showMenu === project.id && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 border border-gray-200">
                    <button
                      ...
                      className="flex items-center space-x-2 w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 w-full px-4 py-2 text-left text-red-600 hover:bg-red-50 cursor-pointer"
                    >
            ...
            <div className="flex gap-2 mt-5 mb-2">
              <button
                ...
                className="flex-[2] bg-golden-500 hover:bg-golden-600 text-white py-2 px-3 rounded-md transition-colors text-sm font-semibold cursor-pointer"
              >
                View Tasks
              </button>
              <button
                onClick={() => onViewReport(project)}
                className="flex-1 border border-gray-300 hover:bg-gray-50 text-gray-700 py-2 px-3 rounded-md transition-colors text-sm font-semibold flex items-center justify-center gap-1.5 cursor-pointer"
                title="View Project Time Report"
              >
                <BarChart2 className="h-4 w-4 text-slate-500" />
                Report
              </button>
            ...
            <span className='py-2 text-sm text-gray-500 block'>Last update: {formatShortDate(project.updated_at)}</span>
          </div>
        </>
      )}
    </div>
